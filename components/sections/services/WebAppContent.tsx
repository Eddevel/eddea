...
import { Globe, Layout, Server, Zap, Search, Shield } from "lucide-react"
...
const process = [
  { step: "1", title: "Discovery & Planning", desc: "Define goals, users, and technical requirements." },
  { step: "2", title: "Design & Prototyping", desc: "Create modern, intuitive interfaces." },
  { step: "3", title: "Development & Testing", desc: "Build and test with best practices." },
  { step: "4", title: "SEO & Optimization", desc: "Ensure fast loading and high rankings." },
  { step: "5", title: "Launch & Support", desc: "Deploy and provide ongoing maintenance." },
]
    ...
    <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-20">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-16">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
          We build fast, scalable, SEO-optimized web applications that deliver exceptional user experiences and business results.
        </p>
      </motion.div>
            ...
            <Card className="h-full bg-gradient-to-b from-background to-muted/20 border-[#deb56a]/20 hover:border-[#deb56a]/40 hover:shadow-[0_10px_30px_rgba(222,181,106,0.15)] transition-all">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#deb56a]/20 to-[#cc0000]/20 flex items-center justify-center mb-4">
                  ...
                  {i === 1 && <Layout className="h-6 w-6 text-[#deb56a]" />}
                  {i === 2 && <Server className="h-6 w-6 text-[#deb56a]" />}
                  {i === 3 && <Zap className="h-6 w-6 text-[#deb56a]" />}
                  {i === 4 && <Search className="h-6 w-6 text-[#deb56a]" />}
                  {i === 5 && <Shield className="h-6 w-6 text-[#deb56a]" />}
                </div>
